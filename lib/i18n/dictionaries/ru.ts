...
/* ============================================================================
   Russian (ru) — LTR, left-to-right.

   NOT YET TRANSLATED. Every key below falls through to the English in
   lib/copy/en.ts, so the site renders correctly in Russian layout with
   English text until a translator fills this in.

   HOW TO FILL THIS IN
     1. `npm run i18n ru` prints every untranslated key with its English
